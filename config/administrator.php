...
return array(
	 ...
	 */
	'menu' => [
		'Users' => ['users', 'children', 'following', 'settingz', 'betacodes', 'invites', 'devices', 'notifications'],
		'Content' => ['posts', 'comments', 'commentattachments', 'postattachments', 'media', 'postlikes'],
		'Financial' => ['usaloans', 'fundingcontributions', 'fundables', 'dwollasourceaccounts', 'dwolladestinationaccounts', 'dwollacustomeraccounts', 'dwollatransfers', 'dwollaevents'],
		'Tools' => ['Invite' => 'route.invite-user', 'Re-Invite' => 'route.re-invite-user'],

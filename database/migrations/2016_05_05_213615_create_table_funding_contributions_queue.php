...
class CreateTableFundingContributionsQueue extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('funding_contribution_queue', function(Blueprint $table)
        {
            $table->increments('id');
    ...
    {
        Schema::drop('funding_contribution_queue');
    }
}
